...
public class calendar extends ActionBarActivity implements View.OnClickListener {
...
//                //varible string tadi kita simpan dalam suatu Bundle, dan kita parse bundle tersebut bersama intent menuju kelas UpdateDeleteActivity
                Intent i = null;
                i = new Intent(calendar.this, calendar_next.class);
                Bundle b = new Bundle();
    ...
    class ReadMhsTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equalsIgnoreCase("Exception Caught")) {
                Toast.makeText(calendar.this, "Unable to connect to server,please check your internet connection!", Toast.LENGTH_LONG).show();
            }

            if (result.equalsIgnoreCase("no results")) {
                Toast.makeText(calendar.this, "Data empty", Toast.LENGTH_LONG).show();
            } else {
                list.setAdapter(new mahasiswaAdapter(calendar.this, daftar_mhs)); //Adapter menampilkan data mahasiswa ke dalam listView
            }
        }
