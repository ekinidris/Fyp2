...
public class calendar_next extends ActionBarActivity {
...
//        EditTxtnim = (EditText) findViewById(R.id.editTextNim);
        ...
        calSession3 = (TextView) findViewById(R.id.calSession3);
        kuliahStart4 = (TextView) findViewById(R.id.kuliahStart3);
        kuliahEnd4 = (TextView) findViewById(R.id.kuliahEnd3);
        entranceStart4 = (TextView) findViewById(R.id.entranceStart3);
        entranceEnd4 = (TextView) findViewById(R.id.entranceEnd3);
        cutiPertStart4 = (TextView) findViewById(R.id.cutiPertStart3);
        cutiPertEnd4 = (TextView) findViewById(R.id.cutiPertEnd3);
        kuliah2Start4 = (TextView) findViewById(R.id.kuliah2Start3);
        kuliah2End4 = (TextView) findViewById(R.id.kuliah2End3);
        sufoStart4 = (TextView) findViewById(R.id.sufoStart3);
        sufoEnd4 = (TextView) findViewById(R.id.sufoEnd3);
        exitStart4 = (TextView) findViewById(R.id.exitStart3);
        exitEnd4 = (TextView) findViewById(R.id.exitEnd3);
        studyweekStart4 = (TextView) findViewById(R.id.studyweekStart3);
        studyweekEnd4 = (TextView) findViewById(R.id.studyweekEnd3);
        examStart4 = (TextView) findViewById(R.id.examStart3);
        examEnd4 = (TextView) findViewById(R.id.examEnd3);
        resultDate4 = (TextView) findViewById(R.id.resultDate3);
        examKhasStart4 = (TextView) findViewById(R.id.examKhasStart3);
        examKhasEnd4 = (TextView) findViewById(R.id.examKhasEnd3);
        cutisemStart4 = (TextView) findViewById(R.id.cutisemStart3);
        cutisemEnd4 = (TextView) findViewById(R.id.cutisemEnd3);
...
//        TxtViewId.setText(isi_id_mhs);
        ...
        calSession3.setText(calSession5);
        ...
        UpdateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                calSession6 = calSession3.getText().toString();
    ...
    class UpdateMhsTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog( calendar_next.this);
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equalsIgnoreCase("Exception Caught")) {
                ...
                Toast.makeText( calendar_next.this, "Unable to connect to server,please check your internet connection!", Toast.LENGTH_LONG).show();
            }

            if (result.equalsIgnoreCase("FAIL")) {
                Toast.makeText( calendar_next.this, "Fail.. Try Again", Toast.LENGTH_LONG).show();
            } else {
                Intent i = null;
                i = new Intent( calendar_next.this, calendar_advisor.class);
                startActivity(i);
            }
    ...
    class DeleteMhsTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equalsIgnoreCase("FAIL")) {
                ...
                Intent i = null;
                i = new Intent( calendar_next.this, calendar.class);
                startActivity(i);
            }
