...
public class calendar_staff_update extends ActionBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calendar_staff_update);
...
//                //varible string tadi kita simpan dalam suatu Bundle, dan kita parse bundle tersebut bersama intent menuju kelas UpdateDeleteActivity
                Intent i = null;
                i = new Intent(calendar_staff_update.this, calendar_staff_next.class);
                Bundle b = new Bundle();
    ...
    class ReadMhsTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(calendar_staff_update.this);
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equalsIgnoreCase("Exception Caught")) {
                Toast.makeText(calendar_staff_update.this, "Unable to connect to server,please check your internet connection!", Toast.LENGTH_LONG).show();
            }

            if (result.equalsIgnoreCase("no results")) {
                Toast.makeText(calendar_staff_update.this, "Data empty", Toast.LENGTH_LONG).show();
            } else {
                list.setAdapter(new mahasiswaAdapter(calendar_staff_update.this, daftar_mhs)); //Adapter menampilkan data mahasiswa ke dalam listView
            }
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_calendar_staff_next, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_add:
                ...
                Intent i = new Intent(calendar_staff_update.this, calendar_staff.class);
                startActivity(i);
                return true;
